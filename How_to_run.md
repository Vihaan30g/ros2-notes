...
Then in src/, run :<br>
`git clone https://github.com/Vihaan30g/ros2-notes.git .`
<br><br>  
...
run following in workspace directory :  
```
...
`ros2 launch bringup trolley_gazebo.launch.xml`  
<br>
...
<br> 
If not having teleop key pkg, install it :  
